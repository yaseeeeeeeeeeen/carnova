...
class SignupOtpScreen extends StatelessWidget {
  ...
  otpSubmit(context) async {
    final otpm = {'otp': otp};
    final response = await ApiServiceHost.instance.hostOtp(otpm);

    if (response.statusCode == 200) {
      final body = jsonDecode(response.body);
      final hostToken = body["token"];
            SharedPreference.instance.storeToken(hostToken);
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('SOMETHING WRONGGG')));
    }
  }
}
