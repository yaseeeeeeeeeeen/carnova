...
List<VehicleFetchModal> vehicleFetchModalFromJson(String str) {
    ...
    return  List<VehicleFetchModal>.from(jsonData.map((x) => VehicleFetchModal.fromJson(x)));
}
...
class VehicleFetchModal {
    ...
    factory VehicleFetchModal.fromJson(Map<String, dynamic> json) =>  VehicleFetchModal(
        id: json["_id"],
        name: json["name"],
        price: json["price"],
        model: json["model"],
